export const allPosts = [
    ...
    ********************************* TEMPLATE *********************************/
...

    {
        name: "Weird Gifts",
        slug: "weird-gifts",
        description: "Weird gifts for those who may not be all there.",
        body: "<p>Do you get insulted by the lack of enthusiasm on people's faces when they unwrap your presents? If so, you are giving them boring gifts.</p><p>Have a look at some of the weird gifts below and buy one for someone's birthday or as a Christmas present. We guarantee they won't look bored when they they receive it. If anything, they'll look really confused as to why you bought them it, and will begin to think you're a weirdo.</p>",
        image: {
